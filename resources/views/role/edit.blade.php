                    ...
                    <form action="{{ route('role.update', $role->id)}}" method="POST" >
                        ...
                        <div class="container">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name" id="name" placeholder="Nombre" value="{{ old('name', $role->name) }}">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="description" id="description" placeholder="Descripcion" rows="3">{{ old('description', $role->description) }}</textarea>
                            </div>
